...
public class RossystemPackageImpl extends EPackageImpl implements RossystemPackage {
	 ...
	 */
	@Override
	public EReference getRosNode_Parent() {
    ...
    public void createPackageContents() {
		...
		createEReference(rosNodeEClass, ROS_NODE__PARENT);
    ...
    public void initializePackageContents() {
		...
		initEReference(getRosNode_Parent(), theRosPackage.getNode(), null, "parent", null, 0, 1, RosNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
