 ...
 *   <li>{@link system.impl.RosNodeImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RosNodeImpl extends ComponentImpl implements RosNode {
	...
	public Node getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RossystemPackage.ROS_NODE__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(Node newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RossystemPackage.ROS_NODE__PARENT, oldParent, parent));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RossystemPackage.ROS_NODE__PARENT:
