	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RosNode_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RosNode_parent_feature", "_UI_RosNode_type"),
				 RossystemPackage.Literals.ROS_NODE__PARENT,
				 true,
				 false,
				 true,
				 null,
